...
public class ProductController {
    ...
    public Product afficherUnProduit(@PathVariable int id) throws ProduitIntrouvableException, ProduitGratuitException {
    ...
    @GetMapping(value = "/AdminProduitsTrierByNom")
